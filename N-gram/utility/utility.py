...
def main():
    ...
    truefileInput = 'data/TrueTopK-1.0.fasta'
    #truefileInput = 'data/msnbc-clo-grams-noisy-l_opt_18-epsilon_1.0-result.res'
    noisefileInput = 'data/TrueTopK-1.0-noise.fasta'
    ...
    TopK( noisefileInput, fileOutput%("noise", top_k), top_k )
